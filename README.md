...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/regex-tester-visualizer.git
   cd regex-tester-visualizer
   ```
...
[![Repo](https://img.shields.io/badge/regex-tester-visualizer-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/regex-tester-visualizer)
